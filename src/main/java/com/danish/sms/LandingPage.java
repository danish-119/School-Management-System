...
public class LandingPage extends Application {
    ...
    public static Scene createLandingPageScene(Stage stage) throws FileNotFoundException {
        ...
        leftPane.getChildren().addAll(Utility.createTextLabel("Welcome User!", 30, 140, 530),Utility.displayImage("/media/danish/8E20E81220E7FF59/Programming/Code/Java Code/IntelliJ IDEA/Projects/School Management System/src/main/resources/smsIcon.png", 120,220));
