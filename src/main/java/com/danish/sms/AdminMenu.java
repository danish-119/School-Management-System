...
public class AdminMenu {
    ...
    public void showAdminMenu(Stage landingPageStage) {
        ...
        leftPane.getChildren().addAll(Utility.createTextLabel("Welcome Admin!",30, "bold" ,140, 530), logoutBtn ,Utility.displayImage("/media/danish/8E20E81220E7FF59/Programming/Code/Java Code/IntelliJ IDEA/Projects/School Management System/src/main/resources/admin.png", 120,220));
