...
public class RemoveStudentPage {
    ...
    public void showRemoveStudentPage(Stage studentManagementStage) {
        ...
        rightPane.getChildren().addAll(studentIdField, searchBtn);
        leftPane.getChildren().addAll(Utility.createTextLabel("Remove Student", 30, "bold" ,120, 530), backBtn, removeBtn,Utility.displayImage("/media/danish/8E20E81220E7FF59/Programming/Code/Java Code/IntelliJ IDEA/Projects/School Management System/src/main/resources/removePerson.png", 120,220));
